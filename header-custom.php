        ...
        <div class="header__content">
            ...
            <nav class="navigation">
                <ul class="navigation__list">
                    ...
                    <li  class="navigation__item"><a href="<?php echo esc_url( home_url( '/' ) ); ?>">Service</a></li>
            ...
            <nav class="hamburger__navigation">
                <ul class="hamburger__navigation--list">
                    ...
                    <li  class="hamburger__navigation--item"><a href="<?php echo esc_url( home_url( '/' ) ); ?>">Service</a></li>
